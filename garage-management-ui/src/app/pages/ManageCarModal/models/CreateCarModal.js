...
import { createCarModal, getAllBrand, getAllCarCategory } from "../services/carModalService";
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-lg w-96">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <select {...register("carCategoryId", { required: true })} className="w-full p-2 border rounded mb-3">
          ...
          <input type="text" {...register("modelName", { required: true })} className="w-full p-2 border rounded mb-3" />
