        ...
        <div className="flex justify-center">
          ...
          <div className="w-full lg:w-1/2 p-0">
            <div className="max-w-[670px] mr-auto pt-[100px] pb-[100px] relative z-10">
              <h2 className="font-semibold text-[38px] text-white mb-10">
                Our Features
              </h2>
              <ul className="list-none p-0">
                <li className="relative pl-[70px] mb-10 ml-[50px]">
                  <i className="absolute left-0 top-0 w-[50px] h-[50px] leading-[50px] text-center text-black bg-[#fdb819] rounded-[10px] text-[27px]">
                    <FaBox size={24} className="text-black text-center" />
                  </i>
                  <h3 className="font-semibold text-[20px] text-white mb-2">
                    Trusted & Quality Work
                  </h3>
                  <p className="text-[#aeadad] text-[14px] max-w-[380px]">
                ...
                <li className="relative pl-[70px] mb-10 ml-[100px]">
                  <i className="absolute justify-center align-center flex left-0 top-0 w-[50px] h-[50px] leading-[50px] text-center text-black bg-[#fdb819] rounded-[10px] text-[27px]">
                ...
                <li className="relative pl-[70px] mb-0 ml-[150px]">
                  <i className="absolute left-0 top-0 w-[50px] h-[50px] leading-[50px] text-center text-black bg-[#fdb819] rounded-[10px] text-[27px]">
                  <FaMoneyBillWave size={24} className="text-black" />
                  </i>
                  <h3 className="font-semibold text-[20px] text-white mb-2">
                    Money Back Guaranty
                  </h3>
