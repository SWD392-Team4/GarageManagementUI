...
export default function CarPartCateModal({ isOpen, onClose, onCarPartCateCreated }) {
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <div className="flex justify-between items-center border-b pb-2 mb-4">
                    <h2 className="text-lg font-semibold text-black">Thêm danh mục phụ tùng</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            {...register("partCategory", { required: "Tên danh mục không được để trống" })}
                            className="w-full p-2 border rounded text-black bg-white"
                        />
                        {errors.partCategory && (
                            <p className="text-red-500 text-sm mt-1">{errors.partCategory.message}</p>
                        )}
                    </div>
