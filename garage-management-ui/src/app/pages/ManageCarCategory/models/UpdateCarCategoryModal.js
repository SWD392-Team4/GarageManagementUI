...
export default function UpdateCarCategoryModal({
  isOpen,
  onClose,
  carCategory,
  onCarCategoryUpdate,
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg w-[600px]">
        ...
        <form>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium">
                {t("manage_car_category.createdAt")}
              </label>
              <input
                type="text"
                {...register("createdAt")}
          ...
          <div className="grid grid-cols-2 gap-4 mt-3">
            <div>
              <label className="block text-sm font-medium">
                {t("manage_car_category.category")}
              </label>
              <input
                type="text"
                {...register("category")}
            ...
            <div>
              <label className="block text-sm font-medium">
                {t("manage_car_category.updatedAt")}
              </label>
              <input
                type="text"
                {...register("updatedAt")}
