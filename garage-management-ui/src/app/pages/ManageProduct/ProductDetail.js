...
const ProductDetail = () => {
    ...
    const product = {
        ...
        manufacture: "Vietnam",
        warranty: "12 months",
        description: "A high-quality engine oil filter designed to improve performance and longevity.",
        images: [
    ...
    return (
        <div className="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4">
            <div className="xl:w-2/6 lg:w-2/5 sm:w-full  flex flex-col items-center">
                <img className="w-full h-80 object-contain rounded-lg " alt={product.name} src={selectedImage} />
                
                
                <div className="flex items-center justify-center mt-4 space-x-2">
                    
                    <button 
                        className={`p-2 rounded-full ${startIndex === 0 ? "text-gray-400 cursor-not-allowed" : "text-gray-700 hover:bg-gray-200"}`}
                    ...
                    <button 
                        className={`p-2 rounded-full ${startIndex + 3 >= product.images.length ? "text-gray-400 cursor-not-allowed" : "text-gray-700 hover:bg-gray-200"}`}
            ...
            <div className="xl:w-2/5 md:w-1/2 lg:ml-8 md:ml-6 md:mt-0 mt-6">
                <div className="border-b border-gray-200 pb-6">
                    <p className="text-md leading-none text-gray-600 mb-3">{product.category}</p>
                    <h1
                        className="
							lg:text-3xl
							text-2xl
                    ...
                    <p className="text-2xl font-semibold mt-6 text-gray-800">{product.price}đ</p>
                </div>
                <div className="text-base lg:leading-tight leading-normal text-gray-600 mt-7 mb-8">
                    ...
                    <p className="text-base leading-4 mt-4 text-gray-600">Brand: {product.brand}</p>
                    <p className="text-base leading-4 mt-4 text-gray-600">Made in: {product.manufacture}</p>
                    <p className="text-base leading-4 mt-4 text-gray-600">Warranty Period: {product.warranty}</p>
                </div>
