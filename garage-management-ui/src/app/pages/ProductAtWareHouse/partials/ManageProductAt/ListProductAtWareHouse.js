...
import { getProductByWareHouse, getProductDetails } from '../../services/ProductAtWarehouseService';
...
export default function ListProductAtWareHouse({ warehouseId }) {
    ...
    const fetchListProduct = async () => {
        ...
        const response = await getProductByWareHouse(warehouseId, searchParams || {});
