      ...
      <>
        ...
        {selectedProduct ? (
            ...
            <div className="mt-4 flex flex-col gap-4">
              ...
              <div>
                <label className="text-gray-500 text-sm">
                  {t("product_at_warehouse.sidebar_product.product_name")}:
                </label>
              ...
              <div>
                <label className="text-gray-500 text-sm">
                  {t("product_at_warehouse.sidebar_product.price")}:
                </label>
              ...
              <div>
                <label className="text-gray-500 text-sm">
                  {t("product_at_warehouse.sidebar_product.status")}:
                </label>
                <span
              ...
              <div>
                <label className="text-gray-500 text-sm">
                  {t("product_at_warehouse.sidebar_product.stock_quantity")}:
                </label>
              ...
              <div>
                <label className="text-gray-500 text-sm">
                  {t("product_at_warehouse.sidebar_product.brand")}:
                </label>
                <p className="text-gray-700 text-md">
              ...
              <div>
                <label className="text-gray-500 text-sm">
                  {t("product_at_warehouse.sidebar_product.barcode")}:
                </label>
                ...
                >
                  <MDEditor.Markdown
                    source={
                      ...
                      t("product_at_warehouse.sidebar_product.no_description")
                    }
                  />
                </div>
              </div>
          ...
          <p className="text-gray-500 text-center">
            {t("product_at_warehouse.sidebar_product.loading")}
          </p>
        )}
      </>
    )
