...
import { sGoodsReceived } from "../ManageGoodReceived/service/GoodsReceivedSignify";
...
export default function ViewGoodsIssued() {
  ...
  const columns = useMemo(
    () => [
      {
        header: t("manage_goods_issued.details_table.id"),
        accessorKey: "id",
        accessorFn: (_row, index) => index + 1,
      },
      {
        header: t("manage_goods_issued.details_table.product_name"),
        accessorKey: "productName",
      },
      {
        header: t("manage_goods_issued.details_table.quantity"),
